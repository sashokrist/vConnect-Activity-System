                ...
                <div class="card">
                    <div class="card-body">
                        <div class="buttons-container">
                            <a class="btn btn-success" href="javascript:void(0)" id="createNewProduct">Create Group</a>
                        </div>
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Enter group name" value="" maxlength="50" required="">
                        </div>
    ...
    <script>
        $(function () {
            ...
            $('#createNewProduct').click(function () {
                ...
                $('#modalHeading').html("Create New Group");
                $('#ajaxModal').modal('show');
            });

            $('body').on('click', '.editProduct', function () {
                var product_id = $(this).data('id');
                $.get("{{ route('group.index') }}" +'/' + product_id +'/edit', function (data) {
                    $('#modalHeading').html("Edit Group");
            ...
            $('#deleteBtn').on('click', function () {
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('group.store') }}"+'/'+productDelete,
                    success: function (data) {
                        table.draw();
                    },
                    error: function (data) {
