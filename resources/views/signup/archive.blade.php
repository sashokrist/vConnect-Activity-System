                ...
                <div class="card">
                    <div class="card-body">
                        <div class="border-container">
                            <form method="post" action="{{ route('signup-archive') }}" autocomplete="off">
                                @csrf
                                <div class="heading">
                                    <h2>{{ $signup->title }}</h2>
                                ...
                                <div class="signup">
                                    <div class="form-group">
                                        <input type="hidden" value="{{ $signup->id }}" name="signid">
            ...
            <div class="col-md-3 side-tile">
                <div class="box">
                    ...
                    @foreach($polls as $poll)
                        <a href="{{ route('polls.index') }}" class="link">{{ $poll->name }}</a>
                    @endforeach
                    @else
                        <p>No related poll</p>
                        @endif
