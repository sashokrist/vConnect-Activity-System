                ...
                <div class="card">
                    <div class="card-body">
                        <div class="border-container">
                            <form method="post" action="{{ route('signups.update', $signup->id) }}" >
                                <div class="form-group">
                                    @csrf
                                    {{ method_field('PUT') }}
                                    <h3>Add Sign up:</h3>
                                    <input type="text" name="title" placeholder="Enter title here" value="{{ $signup->title }}" class="form-control" required/>
                                    @if ($errors->any())
